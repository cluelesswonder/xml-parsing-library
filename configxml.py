...
mykey = myxmlfile.getConfigValue("maxheight")
mykey = myxmlfile.getConfigValue("oops")
mykey = myxmlfile.getConfigValue("doesnotexist")
mykey = myxmlfile.getConfigValue("12345")

result = myxmlfile.setConfigValue("uploadqueue")
result = myxmlfile.setConfigValue("dateformat", "yyyy-dd-MM")
result = myxmlfile.setConfigValue("oops", "crap")
result = myxmlfile.setConfigValue("localftpuser", "nada")
result = myxmlfile.setConfigValue("localftpuser", "banana")
result = myxmlfile.setConfigValue("resizefolder", "BIGGER")
result = myxmlfile.setConfigValue("oops", "crap")
result = myxmlfile.setConfigValue("uploadqueue")

created = myxmlfile.createConfigKey("installdir", "D:\_application\/")
created = myxmlfile.createConfigKey("nada")
created = myxmlfile.createConfigKey("date", "10/27/2014")
created = myxmlfile.createConfigKey("age", "exceeds_limit*.1")
created = myxmlfile.createConfigKey("localftpserver", "D:\_application")
created = myxmlfile.createConfigKey("new", "newer")
created = myxmlfile.createConfigKey("why_123")


kill = myxmlfile.removeConfigKey("dropfolder")
kill = myxmlfile.removeConfigKey("oops")
kill = myxmlfile.removeConfigKey("installdir")
kill = myxmlfile.removeConfigKey("12345")
kill = myxmlfile.removeConfigKey("delimiter")
kill = myxmlfile.removeConfigKey("imagecheckurl")
